    ...
    <main class="pt-20 pb-8 px-4 bg-white dark:bg-black">
        <div class="max-w-7xl mx-auto">
            ...
            <form action="/events" method="POST" enctype="multipart/form-data" class="space-y-6">
                ...
                <!-- Event Name -->
                <div>
                    <label for="event-name" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Event Name</label>
                ...
                <!-- Event Date -->
                <div>
                    <label for="event-date" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Event Date</label>
                ...
                <!-- Event Time -->
                <div>
                    <label for="event-time" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Event Time</label>
                ...
                <!-- Event Description -->
                <div>
                    <label for="event-description" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Description</label>
                ...
                <!-- Event Image -->
                <div>
                    <label for="event-image" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Event Image</label>
