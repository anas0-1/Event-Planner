            ...
            <div class="lg:w-1/2 p-10">
                <form method="POST" action="{{ route('register') }}" class="space-y-6">
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="password" class="block mt-1 w-full px-4 py-3" type="password" name="password" required autocomplete="new-password" />
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input id="password_confirmation" class="block mt-1 w-full px-4 py-3" type="password" name="password_confirmation" required autocomplete="new-password" />
